...
setup(
    name="diffusersv",
    version="0.25.dev",  # expected format is one of x.y.z.dev0, or x.y.z.rc1 or x.y.z (no to dashes, yes to dots)
    ...
    author_email="tvytlx@gmail.com",
    url="https://github.com/tvytlx/diffusers",
    package_dir={"": "src"},
